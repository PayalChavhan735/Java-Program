package Abstraction;
	...
	abstract class Defencee {
		...
		public Defencee(String HeadName,int noofvechicle, int budget, int noofdept, int noofmission, String locationofHeadquator) {
			super();
			this.HeadName=HeadName;
			this.noofvechicle = noofvechicle;
			this.budget = budget;
